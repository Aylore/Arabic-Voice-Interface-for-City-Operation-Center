...
class GoogleTextToSpeech(TextToSpeech):
    def __init__(self, language_code="ar-EG", rate=16000):
    ...
    def postprocess(self, streaming_config):
    ...
    def read_aloud(self):
        streaming_config = self.preprocess()
        self.postprocess(streaming_config)
...
if __name__ == "__main__":
    ...
    tts_arabic = GoogleTextToSpeech(arabic_input_text).read_aloud()
    # tts_english = GoogleTextToSpeech(english_input_text).read_aloud()

"""
	This module provides the hyperparameters used in the LipSyncing process using Wav2Lip 
	for both the discrimnator and the sync_net_colorhis module provides functions for audio processing and spectrogram generation.

...
class Args:
    def __init__(self):
        self.checkpoint_path = 'src/wav2lip/models/wav2lip_gan.pth'
        self.face = 'src/wav2lip/00006.mp4'
        self.audio = 'src/wav2lip/audio.wav'
...
def main(checkpoint_path='src/wav2lip/models/wav2lip_gan.pth', face='src/wav2lip//00006.mp4', audio_path='src/wav2lip//audio.wav',
	 outfile='src/wav2lip/results/result_voice.mp4', static=False, fps=25.0, pads=[0, 10, 0, 0],
	 face_det_batch_size=4, wav2lip_batch_size=128, resize_factor=1, crop=[0, -1, 0, -1],
